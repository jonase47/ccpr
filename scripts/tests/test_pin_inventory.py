...
PENDING = frozenset({
    ...
    ('test_bsd_gnu_portability.py', 'ScannedFilesCoverTheShippedScopeTest',
     'test_an_empty_scope_is_never_a_pass',
     'files+len:call', 'T2'),
    ('test_check_all.py', 'ArtifactGateDenylistSummaryRedProofTest',
     'test_transposed_wording_reports_configured_state_as_not_configured',
    ...
    ('test_check_all.py', 'ConcurrentLockRedProofTest',
     'test_defeating_the_lock_lets_the_second_run_through',
     '.NEEDLE+.count+original:call', 'T3'),
    ...
    ('test_phase_docs_lint.py', 'PhaseFoldersSweepTest',
     ...
     'folders+len:call', 'T4'),
    ('test_p4_sprint_gate_frontmatter.py', 'P4SprintSprintTemplateExtractionTest',
     'test_flat_and_subindex_sprint_templates_are_found',
     'flat_blocks+len:call', 'T4'),
    ('test_p4_sprint_gate_frontmatter.py', 'P4SprintSprintTemplateExtractionTest',
     'test_flat_and_subindex_sprint_templates_are_found',
     'len+subindex_blocks:call', 'T4'),
    ('test_no_bash_agent_runs_tests.py', 'MutationProofTest',
     'test_fires_on_a_synthetic_qa_tester_run_tests_command',
     '[0]+[1]+findings:item', 'T4'),
    ('test_no_bash_agent_runs_tests.py', 'MutationProofTest',
     'test_fires_on_a_synthetic_qa_tester_run_tests_command',
     '[0]+findings:item', 'T4'),
    ('test_no_bash_agent_runs_tests.py', 'MutationProofTest',
    ...
    ('test_no_bash_agent_runs_tests.py', 'NoSummaryFallbackMutationProofTest',
     'test_fires_on_a_command_with_no_fallback',
     'd+find_missing_no_summary_fallback:call', 'T4'),
    ('test_no_bash_agent_runs_tests.py',
     'TranscribeFromSummaryRequiresNoSummaryFallbackTest',
     'test_relying_commands_are_exactly_the_four_fixed_ones',
     'commands_relying_on_run_tests_summary+sorted:call', 'T4'),
    ...
    ('workitems/test_youtrack.py', 'HttpTransportTest',
     ...
     'result:name', 'T4'),
    ('workitems/test_youtrack.py', 'YouTrackAdminProjectsPaginationTest',
     'test_create_resolves_the_project_past_the_first_page',
     '[status]+item:item', 'T4'),
    ...
    ('workitems/test_youtrack.py', 'YouTrackCreateRollbackTest',
     'test_create_does_not_delete_when_initial_state_is_accepted',
     '[status]+item:item', 'T4'),
    ('workitems/test_youtrack.py', 'YouTrackGroupResolutionPaginationTest',
     'test_add_tag_resolves_the_configured_group_past_the_first_page',
     '[visibleFor]+tag:item', 'T4'),
    ...
    def test_the_marker_inventory_is_the_registered_set(self):
        assert_set_matches(  # pin: set pin-marker-inventory
            ...
            {("test_absence_only_assertions.py", "floor", "tests-corpus-files"),
             ...
             ("test_agent_handover_write_boundary.py", "derived",
              "agent-handover-reviewer-block-count"),
             ("test_agent_handover_write_boundary.py", "derived",
              "agent-handover-standard-block-count"),
             ...
             ("test_handover_cap_sentence_echoes.py", "floor",
              "handover-cap-sentence-scope"),
             ("test_handover_cap_sentence_echoes.py", "set",
              "handover-cap-sentence-echoes"),
             ("test_handover_cap_sentence_echoes.py", "set",
              "handover-cap-sentence-scope"),
             ("test_heredoc_interpolation_scan.py", "set",
              "heredoc-known-findings"),
             ("test_instinct_registers_agree.py", "set",
              "instinct-title-annotation-absorbed"),
             ("test_instinct_registers_agree.py", "set",
              "instinct-title-divergences"),
             ("test_instinct_registers_agree.py", "set",
