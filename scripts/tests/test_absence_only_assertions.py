...
class ScannedFilesCoverTheShippedScopeTest(unittest.TestCase):
    def test_scanned_files_cover_the_shipped_scope(self):
        ...
        test's own glob, was 79.

        Bumped 79 -> 80, 16.09.2026 (CCP-1187, integrated 21.09.2026): added
        test_precondition_shows_says_guard.py, the p5-polish.md precondition
        ...
        Bumped 81 -> 82, 16.09.2026 (CCP-1146, integrated 21.09.2026): added
        test_workitems_template.py, the workitems.example.json /
